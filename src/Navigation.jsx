...
//   // EXACT: Handle scroll to change navigation background - same logic
//   useEffect(() => {
//     const handleScroll = () => {
//       const scrollPosition = window.scrollY;
//       const triggerPoint = window.innerHeight * 0.4; // Trigger when 40% down the viewport
...
//   // EXACT: Close menus when clicking outside - same logic
//   useEffect(() => {
//     const handleClickOutside = (event) => {
//       if (!event.target.closest("#navigation")) {
//         setMobileMenuOpen(false);
...
//   // UPDATED: Professional menu items with FD365 content
//   const menuItems = [
//     {
//       title: "Become a driver",
//       subtitle: "Flexible hours, steady income",
...
//       <div
//         id="navigation"
//         className={`fixed top-0 left-0 right-0 z-50 transition-navigation ${
//           isScrolled
...
//             {/* EXACT: Right side - Register & Hamburger */}
//             <div className="flex items-center gap-4">
//               {/* EXACT: Register Button - Desktop only */}
//               <div className="hidden sm:block">
//                 <button
...
//                     className="w-full text-left flex items-center gap-4 px-4 py-4 rounded-lg hover:bg-gray-50/80 transition-all duration-200 group hover:shadow-sm"
//                   >
//                     <div
//                       className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${item.bgColor} ${item.color} group-hover:scale-110 transition-transform duration-200`}
//                     >
...
//                   key={index}
//                   onClick={() => handleNavigation(item.href)}
//                   className={`w-full text-left flex items-center gap-4 px-4 py-4 rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] ${
//                     isScrolled
//                       ? "hover:bg-gray-50 text-gray-900 hover:shadow-sm"
//                       : "hover:bg-white/10 text-white"
//                   }`}

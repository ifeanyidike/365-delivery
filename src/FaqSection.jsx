...
const FaqSection = () => {
  ...
  // UPDATED: FAQ data for 365 Delivery
  const faqs = [
    {
      question: "How do restaurants save money with 365 Delivery?",
      answer:
        "We integrate with your existing apps (Uber, DoorDash, etc.) so you save 5% instantly.",
    },
    {
      question: "How do drivers get paid?",
      answer:
        "Payouts are weekly, with opportunities for bonuses and customer tips.",
    },
    {
      question: "Can I still use Uber or DoorDash if I join 365 Delivery?",
      answer: "Yes — we don't replace your apps, we enhance them.",
    },
    {
      question: "What do I need to become a driver?",
      answer:
        "A valid photo ID, smartphone, and a mode of transport (bike, car, or scooter).",
    },
  ];
            ...
            >
              <h3 className="font-semibold mt-0 text-base md:text-lg mb-2">
                ...
                >
                  ...
                  {/* EXACT: SVG icon with proper rotation */}
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <div
                className={`transition-all overflow-hidden opacity-100 ${
                  faqOpen[index] ? "max-h-48" : "max-h-0"
                }`}
                id={`section-${index}`}
                role="region"
                ...
                style={{ maxHeight: faqOpen[index] ? 48 : 0 }}
              >
                <div itemProp="text">

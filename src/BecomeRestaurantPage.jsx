...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our delivery-management system puts every order from all channels into one dashboard for full visibility. Each order automatically generates a branded live-tracking link with chat and feedback tools, so you and your customer can watch the progress in real time without switching between apps.",
  },
  {
    question: "What if I need onboarding help?",
    answer:
      "Our team will guide you through every step of the setup. We’ll help you connect your ordering platforms, enable the self-delivery option and configure your billing and dispatch settings. If you have questions or hit a snag, just reach out—we’re happy to assist. We want the transition to be seamless, so don’t hesitate to call or email us for personalised onboarding support.",
  },
];

...
//                       Earn on your own terms with flexible delivery
//                       opportunities
//                     </div>
//                   </div>
//                 </div>
...
//                     Work on your own schedule. No minimum hours required.
//                   </div>
//                 </div>
//               </li>
//               <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
//                 <div className="flex flex-col">
//                   <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
//                     Weekly payouts, bonuses & tips
//                   </h5>
//                   <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
//                     Get paid weekly with opportunities for bonuses and customer
//                     tips.
//                   </div>
//                 </div>
//               </li>
...
//                 <div className="flex flex-col">
//                   <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
//                     Deliver with your car, scooter, or bike
//                   </h5>
//                   <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
//                     Use whatever transportation works best for you.
//                   </div>
//                 </div>
//               </li>
//               <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
//                 <div className="flex flex-col">
//                   <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
//                     Boost earnings during busy hours
//                   </h5>
//                   <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
//                     Earn more when demand is high during peak times.
//                   </div>
//                 </div>
//               </li>
//             </ol>
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <div className="flex flex-col w-full">
                  <div className="flex flex-col w-full gap-y-6">
                    <div className="mt-0 text-lg leading-[1.625rem] md:leading-7 font-normal mb-0 text-secondary">
                      Flexible hours, more orders, and better earnings with our
            ...
            <ol className="[counter-reset:ordered-list-counter_var(--start-value,_0)] my-0 pl-0 mt-0 mb-0">
              <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
                <div className="flex flex-col">
                  ...
                  <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
                    Set your own schedule with complete flexibility - no minimum
                    hours required.
                  </div>
                </div>
              </li>
              <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
                <div className="flex flex-col">
                  <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
                    More orders through smart dispatch
                  </h5>
                  <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
                    Our automated system sends you the best delivery
              ...
              <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
                <div className="flex flex-col">
                  <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
                    Weekly payouts plus tips
                  </h5>
                  <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
                    Fast, reliable payments every week with full tip
                    pass-through and bonuses.
                  </div>
                </div>
              </li>
              <li className="flex last:mb-0 mb-8 flex-row [counter-increment:ordered-list-counter] before:content-[counter(ordered-list-counter)] before:shrink-0 before:font-semibold before:bg-action-primary before:text-static-key-light before:flex before:items-center before:justify-center before:rounded-full before:bg-clip-content before:p-0.5 before:mr-4 before:w-6 before:h-6 before:text-xs">
                <div className="flex flex-col">
                  <h5 className="font-semibold mt-0 text-base md:text-lg mb-2">
                    Use any vehicle: car, bike, scooter
                  </h5>
                  <div className="mt-0 text-base leading-6 font-normal mb-0 text-secondary">
                    Deliver with whatever transportation works best for you and
                    your area.
                  </div>
                </div>
              </li>
